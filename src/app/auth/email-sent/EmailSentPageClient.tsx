...
interface EmailSentPageClientProps {
  email: string | null;
  emailSent: boolean;
}

export default function EmailSentPageClient({ email, emailSent }: EmailSentPageClientProps) {
  ...
  if (!email) {
    return <LoadingScreen message="登録ページにリダイレクト中..." />;
  }
