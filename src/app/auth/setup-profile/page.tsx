...
export default function SetupProfilePage() {
  ...
  return (
    <div className="h-full w-full flex flex-col items-center justify-start sm:justify-center gap-1.5 mt-1.5 sm:mt-0 sm:gap-2 max-w-[800px] sm:mb-3 overflow-y-auto">
      {/* Header */}
